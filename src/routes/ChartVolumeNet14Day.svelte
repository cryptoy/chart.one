<script>
	...
	const updateChart = () => {
		...
		avaxPlotData = [
			(vol - parseFloat(stats.avax.history14day.volumeBuy)) * price -
				(sellVol - parseFloat(stats.avax.history14day.volumeSell)) * price,
			(vol - parseFloat(stats.avax.history7day.volumeBuy)) * price -
				(sellVol - parseFloat(stats.avax.history7day.volumeSell)) * price,
		...
		bscPlotData = [
			(vol - parseFloat(stats.bsc.history14day.volumeBuy)) * price -
				(sellVol - parseFloat(stats.bsc.history14day.volumeSell)) * price,
			(vol - parseFloat(stats.bsc.history7day.volumeBuy)) * price -
				(sellVol - parseFloat(stats.bsc.history7day.volumeSell)) * price,
		...
		ethPlotData = [
			(vol - parseFloat(stats.eth.history14day.volumeBuy)) * price -
				(sellVol - parseFloat(stats.eth.history14day.volumeSell)) * price,
			(vol - parseFloat(stats.eth.history7day.volumeBuy)) * price -
				(sellVol - parseFloat(stats.eth.history7day.volumeSell)) * price,
		...
		ftmPlotData = [
			(vol - parseFloat(stats.ftm.history14day.volumeBuy)) * price -
				(sellVol - parseFloat(stats.ftm.history14day.volumeSell)) * price,
			(vol - parseFloat(stats.ftm.history7day.volumeBuy)) * price -
				(sellVol - parseFloat(stats.ftm.history7day.volumeSell)) * price,
		...
		polyPlotData = [
			(vol - parseFloat(stats.poly.history14day.volumeBuy)) * price -
				(sellVol - parseFloat(stats.poly.history14day.volumeSell)) * price,
			(vol - parseFloat(stats.poly.history7day.volumeBuy)) * price -
				(sellVol - parseFloat(stats.poly.history7day.volumeSell)) * price,
